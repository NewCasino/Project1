...
<script type="text/C#" language="C#" runat="Server">
    private string GetGameMonitorUrl()
    {
        if( Request.Cookies["gmcoresid"] == null )
            return string.Empty;
        return string.Format(ConfigurationManager.AppSettings["GameMonitorUrl"]
            , Request.Cookies["gmcoresid"].Value
            , DomainManager.CurrentDomainID
            , (CurrentUserSession.IsSystemUser && DomainManager.CurrentDomainID == Constant.SystemDomainID) ? "1" : "0"
            );
    }
</script>
