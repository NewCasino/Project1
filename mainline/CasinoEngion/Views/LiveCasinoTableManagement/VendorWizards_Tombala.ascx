...
<script language="C#" type="text/C#" runat="server">
    ...
    private List<SelectListItem> GetTombalaGames()
    {
        var p = new Dictionary<string, object>()
        {
            { "VendorID" , new VendorID[] { VendorID.Tombala } }
        };
        int total = 0;
...
<%: Html.DropDownList("gameID", GetTombalaGames(), new { @class = "ddl", @id = "ddlTombalaGameID"}) %>
</p>
...
<p style="position:absolute; bottom:0px; right:0px; width:auto;">
    <button id="btnRegTombala">Submit</button>
</p>    
