...
<script language="C#" type="text/C#" runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        url.Append(Domain.GetCfg(Kiron.GameBaseURL));
        url.AppendFormat("?dg={0}&l={1}&o={2}&freePlay={3}&mobile={4}&clientId={5}&mode={6}",
            this.Model.GameID,
            this.Language,
            Domain.GetCfg(Kiron.PartnerID),
            FunMode ? "true" : "false",
            mobileDevice ? "true" : "false",
            Domain.GetCfg(Kiron.ClientID),
            Domain.GetCfg(Kiron.Mode)
            );
        ...
        if (!FunMode)
        {
            ...
            startUrl += String.Format("&i={0}&p={1}&c={2}", UserSession.UserID, response.TokenKey, currency);
        }
...
<body>
    ...
    <%=InjectScriptCode(Kiron.CELaunchInjectScriptUrl) %>
