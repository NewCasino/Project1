...
<script language="C#" type="text/C#" runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        url.Append(Domain.GetCfg(Mrslotty.GameBaseURL));
        url.AppendFormat("?gameCode={0}&language={1}&operatorId={2}{3}&mobile={4}&clientId={5}&mode={6}",
            this.Model.GameID,
            this.Language,
            Domain.GetCfg(Mrslotty.PartnerID),
            FunMode ? "&freePlay=true" : "",
            mobileDevice ? "true" : "false",
            Domain.GetCfg(Mrslotty.ClientID),
            Domain.GetCfg(Mrslotty.Mode)
            );
...
<body>
    ...
    <%=InjectScriptCode(Mrslotty.CELaunchInjectScriptUrl) %>
