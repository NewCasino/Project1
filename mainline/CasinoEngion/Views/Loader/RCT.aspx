...
<script language="C#" type="text/C#" runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        url.Append(Domain.GetCfg(RCT.GameBaseURL));
        url.AppendFormat("?gameCode={0}&language={1}&operatorId={2}&freePlay={3}&mobile={4}&externalPartnerId={5}&mode={6}",
            this.Model.GameID,
            this.Language,
            Domain.GetCfg(RCT.PartnerID),
            FunMode ? "true" : "false",
            mobileDevice ? "true" : "false",
            Domain.GetCfg(RCT.ClientID),
            Domain.GetCfg(RCT.Mode)
            );
...
<body>
    ...
    <%=InjectScriptCode(RCT.CELaunchInjectScriptUrl) %>
