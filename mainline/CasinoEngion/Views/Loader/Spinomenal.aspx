...
<script language="C#" type="text/C#" runat="server">
    ...
    protected override void OnInit(EventArgs e)
    {
        ...
        url.Append(Domain.GetCfg(Spinomenal.GameBaseURL));
        url.AppendFormat("?gameCode={0}&language={1}&operatorId={2}&freePlay={3}&mobile={4}&clientId={5}&mode={6}",
            this.Model.GameID,
            this.Language,
            Domain.GetCfg(Spinomenal.PartnerID),
            FunMode ? "true" : "false",
            mobileDevice ? "true" : "false",
            Domain.GetCfg(Spinomenal.ClientID),
            Domain.GetCfg(Spinomenal.Mode)
            );
...
<body>
    ...
    <%=InjectScriptCode(Spinomenal.CELaunchInjectScriptUrl) %>
