<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CmsStyle.Publish.Default" %>
...
<body>        
    ...
    <div id="c-single">
        Distinct Name: <input type="text" id="txtDistinctName" /> <button id="btnPubSingle" data-handle="/Handler.ashx">Publish</button>
    ...
    <div id="c-list" style="display:none;">
        ...
        <a id="e-all">All</a> <a id="e-none">None</a>  <a id="e-invert">Invert</a>
            <button id="btnPubList" data-handle="/Handler.ashx">Publish</button>
