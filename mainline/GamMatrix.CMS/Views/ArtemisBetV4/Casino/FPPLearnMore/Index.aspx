...
<div class="Breadcrumbs" role="navigation">
        <ul class="BreadMenu Container" role="menu">
            ...
            <li class="BreadItem BreadCurrent" role="menuitem" itemtype="http://data-vocabulary.org/Breadcrumb" itemscope="itemscope">
                <a class="BreadLink url" href="<%= this.GetMetadata("/Metadata/Breadcrumbs/Home/FPP/.Url") %>" itemprop="url" title="<%= this.GetMetadata("/Metadata/Breadcrumbs/Home/ResponsibleGaming/.Title") %>">
                    <span itemprop="title"><%= this.GetMetadata("/Metadata/Breadcrumbs/Home/FPP/.Name") %></span>
                </a>
            </li>  
        </ul>
    </div>
<div id="casino-fpp-wrapper" class="content-wrapper ResponsibleGamingContainer">
<h1 class="PageTitle"> <%: this.GetMetadata(".Title") %> </h1>
