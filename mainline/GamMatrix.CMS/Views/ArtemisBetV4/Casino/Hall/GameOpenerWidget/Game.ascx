...
<script type="text/javascript">
    ...
    $(function () {
        $('ul.ControllerButtons li.CBFav a.Button').click(function (e) {
            e.preventDefault();
            var FavStatus = $('ul.ControllerButtons li.CBFav').hasClass('CBActive') ;
            ...
            var fun = (function (o) {
                return function () {
                    //o.fadeOut();
                    FavStatus ? $('ul.ControllerButtons li.CBFav').removeClass("CBActive") :$('ul.ControllerButtons li.CBFav').addClass("CBActive") ;
