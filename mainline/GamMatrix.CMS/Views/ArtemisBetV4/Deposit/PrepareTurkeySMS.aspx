...
<% using (Html.BeginRouteForm("Deposit", new { @action = "ProcessTurkeySMSTransaction"
       , @paymentMethodName = this.Model.UniqueName }
       , FormMethod.Post
       , new { @id = "formProcessTurkeySMSDeposit", @target = "_self" }
       ))
   { %>
...
<ControlPart>
        <table class="holder-flex-100">
            <tr class="holder-flex-100">
                <td class="controls col-50">
...
<script type="text/javascript">
    $(function () {
        $('#formProcessTurkeySMSDeposit').initializeForm();

        $('#btnArtemisSMSContinue').click(function (e) {
            e.preventDefault();

            if (!$('#formProcessTurkeySMSDeposit').valid())
                return;

            $('#formProcessTurkeySMSDeposit').hide();
            $('#confirm_step').show();
        ...
        $('#btnArtemisSMSBack').click(function (e) {
            e.preventDefault();
            $('#formProcessTurkeySMSDeposit').show();
            $('#confirm_step').hide();
        });
        ...
        $('#btnArtemisSMSDeposit').click(function (e) {
            ...
            $('#formProcessTurkeySMSDeposit').ajaxForm(options);
            $('#formProcessTurkeySMSDeposit').submit();
        });
