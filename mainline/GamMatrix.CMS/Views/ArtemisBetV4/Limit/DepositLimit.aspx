...
<form action="/Limit/SetDepositLimit" id="formDepositLimit" target="_self" method="post">

<div id="deposit-limit" class="deposit-limit">
...
<ui:Button runat="server" Text="<%$ Metadata:value(.Button_Submit) %>" id="btnSubmitDepositLimit" type="submit"></ui:Button>
<ui:Button runat="server" Text="<%$ Metadata:value(.Button_Change) %>" id="btnChangeDepositLimit" type="button"></ui:Button>
<ui:Button runat="server" Text="<%$ Metadata:value(.Button_Remove) %>" id="btnRemoveDepositLimit" type="submit"></ui:Button>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btnChangeDepositLimit').click(function (e) {
            ...
            $('#txtDepositLimitAmount').attr('readonly', false);
        ...
        $('#btnRemoveDepositLimit').click(function (e) {
            ...
            $(this).toggleLoadingSpin(true);
            $('#formDepositLimit').attr('action', '/Limit/RemoveDepositLimit');
        });
    });
</script>
</ui:MinifiedJavascriptControl>
