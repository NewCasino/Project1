...
<form action="/Limit/SetLossLimit" id="formLossLimit" target="_self" method="post">
...
<ui:Button runat="server" Text="<%$ Metadata:value(.Button_Submit) %>" id="btnSubmitLossLimit" type="submit"></ui:Button>
<ui:Button runat="server" Text="<%$ Metadata:value(.Button_Change) %>" id="btnChangeLossLimit" type="button"></ui:Button>
<ui:Button runat="server" Text="<%$ Metadata:value(.Button_Remove) %>" id="btnRemoveLossLimit" type="submit"></ui:Button>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#btnChangeLossLimit').click(function (e) {
            ...
            $('#txtLossLimitAmount').attr('readonly', false);
