...
<div class="withdraw_steps" id="withdraw_steps">
    <div id="prepare_step" class="prepare_step">
        <% Html.RenderPartial("InputView", this.Model); %>
        <% Html.RenderPartial(this.ViewData["PayCardView"] as string, this.Model); %>
    </div>
    <div id="confirm_step" class="confirm_step" style="display:none">
    </div>
    <div id="error_step" class="error_step" style="display:none">
        <div class="Container Box PrepareBTNContainer PrepareErrorBTNs">
