...
{
decimal amount = decimal.Parse(Model.StateVars["amount"]);
...
<% if (Model.ShowSenderPhoneNumber && Model.PaymentMethod.UniqueName != "TurkeySMS_Yapikredi")
   { %>
<li>
<div class="ProfileDetail">
...
<input id="receiverBirthDate" name="receiverBirthDate" type="hidden" value="<%= GetBirthDate()%>">
</div>
</li>
<% } %>
...
<% } %>
<% if (Model.ShowReceiverTCNumber || Model.PaymentMethod.UniqueName == "TurkeySMS_Yapikredi")
{ %>
<li>
<div class="ProfileDetail">
