...
%>
    <li class="MenuItem X PromoItem">
        <a href="#" class="MenuLink A Container ToggleButton">
            <span class="Page I">Logo</span>
            <span class="UserInfo">
                <span class="PromoItemTitle"><%=this.Model.GetPromoTitle(path).SafeHtmlEncode()%></span>
                <span class="PromoItemClick"><%=this.GetMetadata(".ClickForDetails").HtmlEncodeSpecialCharactors()%></span>
            </span>
        ...
        <div class="ToggleContent" style="display: none;">
            <div class="Container PromoContent">
                ...
                <div class="AccountButtonContainer">
                    <a href="<%=this.Model.GetTermsUrl(path) %>" class="Button AccountButton">
                        <strong class="ButtonText"><%= this.GetMetadata(".ButtonText").HtmlEncodeSpecialCharactors()%></strong>
                    </a>
                </div>
            </div>
            <a href="#" class="MoreLink M ToggleClose">
                <span class="MW">
                    <span class="MoreText"><%=this.GetMetadata(".CloseDetails").SafeHtmlEncode()%></span>
