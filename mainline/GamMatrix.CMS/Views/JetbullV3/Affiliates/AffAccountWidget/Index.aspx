...
<div class="affiliate">
    <form id="affiliateForm" name="affiliateForm" action="<%=this.GetMetadata("/Metadata/Affiliate.formActionPath")%>" target="_top">
        <!--<label for="username" class="AffiliatesLabel"><%= this.GetMetadata(".AffiliatesLabel").SafeHtmlEncode() %></label>-->
        <div id="login-box">
            ...
            <div id="login-pane">
                <!--<div class="username_wrap">
                    <%: Html.TextboxEx("username", "", this.GetMetadata("/Head/_LoginPane_ascx.Username_Wartermark"), new { placeholder = this.GetMetadata("/Head/LoginPane.Username_Wartermark") })%>
                </div>
                <div class="password_wrap">
                    <%: Html.TextboxEx("password", "", this.GetMetadata("/Head/_LoginPane_ascx.Password_Wartermark"), new { type = "password", placeholder = this.GetMetadata("/Head/LoginPane.Password_Wartermark") })%>
                </div>-->
                <div class="login_btn">
