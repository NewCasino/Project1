...
<script language="C#" type="text/C#" runat="server">
    ...
    public string GetPropValue(object src, string propName, string metadataName)
    {
        ...
        {
            var propVal = type.GetProperty(propName).GetValue(src, null);
...
<% 
    ...
    else
    {
        ...
        {%>
    <table cellpadding="0" cellspacing="0" border="1" rules="all" class="confirmation_table" data-priority="<%= bonus.Priority %>" >
        ...
        <% if (string.Equals(bonus.Status, "Queued", StringComparison.InvariantCultureIgnoreCase)) {
               ...
               %>
         <tr>
             <td class="value <%=bonus.BonusID %>" colspan="2">
