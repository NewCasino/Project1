...
{ %>
<a class="Button HomeButtonHeader SportsButtonHeader" href="<%= Url.RouteUrl("Sports_Home").SafeHtmlEncode()%>">
<span class="ButtonIcon"><%= this.GetMetadata(".Icon_Sports").SafeHtmlEncode()%></span>
</a>
<% }
else
{ %>
<a class="Button HomeButtonHeader CasinoButtonHeader" href="<%= this.Url.RouteUrl("CasinoLobby").SafeHtmlEncode()%>">
...
<li class="RegItem">
<a class="Button RegLink SignUpLink" href="<%= Url.RouteUrl("Register")%>" id="signUpLink">
