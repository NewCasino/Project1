...
<div class="UserBox DepositBox CenterBox">
	<div class="BoxContent">
		...
		<form action="<%= this.Url.RouteUrl("Deposit", new { action = "PrepareTransaction", paymentMethodName = this.Model.PaymentMethod.UniqueName }).SafeHtmlEncode() %>" method="post" id="formPrepareMoneyMatrix">
            
    		<% Html.RenderPartial("/Components/MultiFormState", Model.StateVars); %>
            
        <% Html.RenderPartial("/Components/MoneyMatrix_CreditCardPayCard",
         new MoneyMatrixCreditCardPrepareViewModel(TransactionType.Deposit, new List<string> { "VI", "VD", "VE" })); %>
