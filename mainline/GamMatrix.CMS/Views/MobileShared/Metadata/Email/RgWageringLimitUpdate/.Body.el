<p>Αγαπητέ -ή $USERNAME$, <br /> <br /> Σας ευχαριστούμε που επικοινωνήσατε με  [Metadata:htmlencode(/Metadata/Settings.Operator_DisplayName)]<br /> <br /> Αυτό το email σας στέλνεται ως επιβεβαίωση της αλλαγής του προσωπικού σας ορίου πονταρίσματος από&nbsp;$LIMITAMOUNT$ $LIMITPERIOD$&nbsp;στα $NEWLIMITAMOUNT$ $NEWLIMITPERIOD$. <br /> <br /> Για οποιαδήποτε απορία ή διευκρίνηση μην διστάσετε να επικοινωνήσετε μαζί μας στο <a href="mailto:[Metadata:htmlencode(/Metadata/Settings.Email_SupportAddress)]">[Metadata:htmlencode(/Metadata/Settings.Email_SupportAddress)]</a></p>
<p>&nbsp;</p>
