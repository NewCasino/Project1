...
<script language="C#" type="text/C#" runat="server">
    ...
    private SelectListItem[] GetTypeList()
    {
        ...
        list.Add(new SelectListItem()
        {
            ...
            Value = "Deposit",
            Selected = string.Equals( Request.QueryString["type"], "Deposit", StringComparison.InvariantCultureIgnoreCase),
        });
        ...
        list.Add(new SelectListItem()
        {
            ...
            Value = "Withdraw",
            Selected = string.Equals(Request.QueryString["type"], "Withdraw", StringComparison.InvariantCultureIgnoreCase)
        });
        ...
        list.Add(new SelectListItem()
        {
            ...
            Value = "Transfer",
            Selected = string.Equals(Request.QueryString["type"], "Transfer", StringComparison.InvariantCultureIgnoreCase)
        });
        ...
        list.Add(new SelectListItem()
        {
            ...
            Value = "BuddyTransfer",
            Selected = string.Equals(Request.QueryString["type"], "BuddyTransfer", StringComparison.InvariantCultureIgnoreCase)
        });
        ...
        if ( true )
        {
            list.Add(new SelectListItem()
            {
                Text = this.GetMetadata(".Type_Gambling"),
                Value = "Gambling",
                Selected = string.Equals(Request.QueryString["type"], "Gambling", StringComparison.InvariantCultureIgnoreCase)
            });
        }
...
<script language="javascript" type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#btnSearchTransactionHistory').click(function (e) {
            ...
            var startTime = new Date($("#filterDateFrom").val());
            var endTime = new Date($("#filterDateTo").val());
            if (startTime > endTime) {
                alert('<%=this.GetMetadata(".Date_InvalidEndDate").SafeJavascriptStringEncode() %>');
                return;
            }
