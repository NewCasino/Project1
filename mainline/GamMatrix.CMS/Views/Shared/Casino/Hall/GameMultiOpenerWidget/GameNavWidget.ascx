...
<div class="Box AllGames" id="gameMultiOpenerNavWidget<%= ID %>">
        ...
        <div class="GameFilters">
            <form class="FilterForm SearchFilterForm" id="gameSearch<%= ID %>" action="#" onsubmit="return false">
                ...
                <fieldset>
                    ...
                    <input class="FilterInput" type="search" id="txtGameSearchKeywords<%= ID %>" name="txtGameSearchKeywords" accesskey="g" maxlength="50" value="" placeholder="<%= this.GetMetadata(".GameName_PlaceHolder").SafeHtmlEncode() %>" />
                ...
                <fieldset>
                    ...
                    ----------------------------%>
                        <div class="GLTutorial">
                            <a class="GLTutorialButton" id="lnkGameNavTutorial<%= ID %>" href="javascript:void(0)" title="<%= this.GetMetadata(".Button_Tutorial_Title").SafeHtmlEncode()%>">?
                            </a>
                        </div>
                    ...
                    ----------------------------%>
                        <div class="GFListWrapper GFL2 GLViewSwitcher">
                            <ul class="GFilterList Container" id="gfl-display<%= ID %>">
                                <li class="GFilterItem GFilterDropdown">
                                    <a class="GFDLink GFDSymbol" id="gfl-displayTrigger<%= ID %>" href="#" title="<%= this.GetMetadata(".ViewSwitcher_Title").SafeHtmlEncode()%>">
                                        <span class="GFDText"><span class="Hidden"><%= this.GetMetadata(".Filters_See_All").SafeHtmlEncode()%></span><span class="ActionSymbol">&#9660;</span></span>
                                        <span class="GFDInfo"><span class="GFDVar" id="gfdVar-display<%= ID %>"><%= this.GetMetadata(".ViewSwitcher_Grid").SafeHtmlEncode()%></span></span>
                                    </a>
                                </li>
                                <li class="GFilterItem GFGrid GFActive">
                                    <label for="gfGrid<%= ID %>" class="GFLabel" title="<%= this.GetMetadata(".ViewSwitcher_Grid_Title").SafeHtmlEncode()%>">
                                        <input type="radio" checked="checked" id="gfGrid<%= ID %>" name="displayType" value="Grid" class="hidden" />
                                ...
                                <li class="GFilterItem GFList">
                                    <label for="gfList" class="GFLabel" title="<%= this.GetMetadata(".ViewSwitcher_List_Title").SafeHtmlEncode()%>">
                                        <input type="radio" id="gfList<%= ID %>" name="displayType" value="List" class="hidden" />
                    ...
                    ----------------------------%>
                        <div class="GFListWrapper GFL3 GLSortList">
                            <ul class="GFilterList Container" id="gfl-sorting<%= ID %>">
                                <li class="GFilterItem GFilterDropdown">
                                    <a class="GFDLink GFDSymbol" id="gfl-sortingTrigger<%= ID %>" href="#" title="<%= this.GetMetadata(".SortSwitcher_Title").SafeHtmlEncode()%>">
                                        <span class="GFDText"><span class="Hidden"><%= this.GetMetadata(".Filters_See_All").SafeHtmlEncode()%></span><span class="ActionSymbol">&#9660;</span></span>
                                        <span class="GFDInfo GFDefault"><span class="GFDVar" id="gfdVar-sorting<%= ID %>"><%= this.GetMetadata(".SortSwitcher_Default").SafeHtmlEncode()%></span></span>
                                    </a>
                                </li>
                                <li class="GFilterItem GFAlphabetical">
                                    <label for="gfAlphabetical" class="GFLabel" title="<%= this.GetMetadata(".SortSwitcher_Alphabetical_Title").SafeHtmlEncode()%>">
                                        <input type="radio" id="gfAlphabetical<%= ID %>" name="sortType" value="alphabetical" class="hidden" />
                                ...
                                <li class="GFilterItem GFPopularity">
                                    <label for="gfPopularity" class="GFLabel" title="<%= this.GetMetadata(".SortSwitcher_Popularity_Title").SafeHtmlEncode()%>">
                                        <input type="radio" id="gfPopularity<%= ID %>" name="sortType" value="popularity" class="hidden" />
                                ...
                                <li class="GFilterItem GFDefault GFActive">
                                    <label for="gfDefault" class="GFLabel" title="<%= this.GetMetadata(".SortSwitcher_Default_Title").SafeHtmlEncode()%>">
                                        <input type="radio" checked="checked" id="gfDefault<%= ID %>" name="sortType" value="" class="hidden" />
                    ...
                    ----------------------------%>
                        <div class="GFListWrapper GFL4 GLOpenModeList">
                            <ul class="GFilterList Container" id="gfl-opening<%= ID %>">
                                <li class="GFilterItem GFilterDropdown">
                                    <a class="GFDLink GFDSymbol" id="gfl-openingTrigger<%= ID %>" href="#" title="<%= this.GetMetadata(".OpenMode_Title").SafeHtmlEncode()%>">
                                        <span class="GFDText"><span class="Hidden"><%= this.GetMetadata(".Filters_See_All").SafeHtmlEncode()%></span><span class="ActionSymbol">&#9660;</span></span>
                                        <span class="GFDInfo GFPopup"><span class="GFDVar" id="gfdVar-opening<%= ID %>"><%= this.GetMetadata(".OpenMode_Popup").SafeHtmlEncode()%></span></span>
                                    </a>
                                </li>
                                <li class="GFilterItem GFPopup GFActive">
                                    <label for="gfPopup" class="GFLabel" title="<%= this.GetMetadata(".OpenMode_Popup_Title").SafeHtmlEncode()%>">
                                        <input type="radio" checked="checked" id="gfPopup<%= ID %>" name="openType" value="popup" class="hidden" />
                                ...
                                <li class="GFilterItem GFInline">
                                    <label for="gfInline" class="GFLabel" title="<%= this.GetMetadata(".OpenMode_Inline_Title").SafeHtmlEncode()%>">
                                        <input type="radio" id="gfInline<%= ID %>" name="openType" value="inline" class="hidden" />
                                ...
                                <li class="GFilterItem GFNewTab">
                                    <label for="gfNewTab" class="GFLabel" title="<%= this.GetMetadata(".OpenMode_NewTab_Title").SafeHtmlEncode()%>">
                                        <input type="radio" id="gfNewTab<%= ID %>" name="openType" value="newtab" class="hidden" />
                                ...
                                <li class="GFilterItem GFFullScreen">
                                    <label for="gfFullScreen" class="GFLabel" title="<%= this.GetMetadata(".OpenMode_Fullscreen_Title").SafeHtmlEncode()%>">
                                        <input type="radio" id="gfFullScreen<%= ID %>" name="openType" value="fullscreen" class="hidden" />
                    ...
                    <button type="submit" class="Button hidden" name="gameFilterSubmit" id="btnFilterVendor<%= ID %>">
                        <span>Filter</span>
                    </button>
                </fieldset>
            </form>
    ...
    <div class="GamesCategoriesDrop">
        <a class="GFDLink" id="gfl-cats<%= ID %>" href="#" title="Filter the games by category">
    ...
    <div class="GamesContainer">
        ...
        <div id="divIncentiveMessage<%= ID %>" class="Hidden"></div>

        <div class="GamesControls">
            <a id="lnkLoadMoreGames<%= ID %>" class="Button LoadMoreButton Hidden" href="#" title="<%= this.GetMetadata(".Button_LoadMore_Title").SafeHtmlEncode()%>">
                <span class="ButtonText"><%= this.GetMetadata(".Button_LoadMore").SafeHtmlEncode()%>&nbsp;<span class="ActionSymbol">&#9660;</span></span>
            </a>
            <a id="lnkLoadAllCategories<%= ID %>" class="Button LoadMoreButton Hidden" href="#">
