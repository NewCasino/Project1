...
<div class="CasinoGameOverlay Multi" style="background-image: url(<%= this.Model.BackgroundImageUrl %>)" id="<%= this.ID %>">
    <div class="Wrapper1">
        <div class="Wrapper2">
            <div class="PopupContainer">
                ...
                <% if (Metadata.Get("/Metadata/Settings.EnableCasinoClock").ParseToBool(false) == true){ %>
                <% Html.RenderPartial("/Components/Clock", this.ViewData.Merge(new { })); %>
                <% } %>
            </div>
    ...
    <%if(Settings.GRE_Enabled) { %>
     <% Html.RenderPartial("/Components/GameRecommendedGames", this.ViewData.Merge( new { @Title = "Game Recomended Games",@GameID=this.Model.ID , @CssClass = "GammingWindowPopWidget" })); %>
    <%}%>
...
<script type="text/javascript">
    function gameMultiOpenerWidget(){
        ...
        var gameBarWidgetInstance = null;
        ...
        function init(){
            ...
            var wrapperFirst = $('.GameLoaderWrapper:first');
            var menuIconFirst = wrapperFirst.find('.menu-icon');
            wrapperFirst.hover(function(){
                if(container.hasClass('fourth'))
                    menuIconFirst.show();
            },function(){
                menuIconFirst.hide();
            });
        ...
        function EnterFullScreen2(selector,target) {
            ...
            function initGameBarWidget(){
                ...
                gameBarWidgetInstance = window['gameNavBarWidget_' + gameBarWidgetContainerId.split('_')[1]];
