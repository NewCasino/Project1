...
<div class="Box Jackpots" id="<%= ClientID %>">
	<h2 class="BoxTitle JackpotsTitle">
		...
		<a href="/casino/jackpots" class="TitleLink" 
            title="<%= this.GetMetadata(".All_Jackpots_Link_Tip").SafeHtmlEncode()%>">
	...
	<ul class="JackpotsControl Controls">
		<li class="Prev">
			<a href="#" class="PrevLink" title="<%= this.GetMetadata(".Previous_Jackpot_Tip").SafeHtmlEncode()%>">&#9668;</a>
		</li>
		<li class="Next">
