...
%>
	...
	<div class="BoxTitle">
		<a class="TitleText GoTop" href="#">
			<span class="Icon">&#8593;</span>
			<span><%= this.GetMetadata(".GoToTop") %></span>
		</a>
	</div>
</div>
