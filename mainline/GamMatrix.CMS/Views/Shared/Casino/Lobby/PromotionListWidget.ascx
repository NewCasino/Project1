...
<div class="Box Promotions">
	<h2 class="BoxTitle PromotionTitle">
...
<% 
    ...
    { %>
		<a href="<%= allPromotionsPageUrl.SafeHtmlEncode() %>"
            class="TitleLink" title="<%= this.GetMetadata(".All_Promotions_Link_Tip").SafeHtmlEncode()%>">
