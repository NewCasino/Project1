            ...
            <% 
                ...
                foreach (TransInfoRec trans in _Transactions)
                {
                    ...
                    <tr id="<%= trans.TransID.ToString() %>" class="trans-item <%= isAlternate ? "odd" : "" %> <%= trans.TransStatus.ToString().ToLowerInvariant() %>">
                        ...
                        <td class="col-4"><span><%= MoneyHelper.FormatCurrencySymbol(MoneyHelper.FormatWithCurrency( trans.DebitRealCurrency, trans.DebitRealAmount)) %></span></td>
        ...
        <script type="text/ecmascript">
            $(function () {
                ...
                $(".sec-transactionlist .button").click(function (e) {
                    ...
                    $.post("/Deposit/Rollback", { sid: self.attr("sid") }, function (rlt) {
                        if (rlt.success) {
