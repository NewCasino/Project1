...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.externalItem button').not('.unenable').click(function () {
            g_wnd = openWnd('/ExternalLogin/Associate?authParty=' + $(this).attr('code') + "&status=" + $(this).attr('action'));
        });
    });
</script>
<div class="external_wrap">
    ...
    <div class="external_loginpanel">
        <ul>
            <% if (AuthParty_Setting.Enable_Facebook)
               { %>
            <li class="externalItem"><a code="<%= ExternalAuthParty.Facebook %>" class="item_Facebook" title="Facebook"></a></li>
            <%} %>
            <% if (AuthParty_Setting.Enable_Google)
               { %>
            <li class="externalItem"><a code="<%= ExternalAuthParty.Google %>" class="item_Google" title="Google"></a></li>
            <%} %>
            <% if (AuthParty_Setting.Enable_MailRu)
               { %>
            <li class="externalItem"><a code="<%= ExternalAuthParty.MailRu %>" class="item_MailRu" title="Mail.ru"></a></li>
            <%} %>
            <% if (AuthParty_Setting.Enable_Twitter)
               { %>
            <li class="externalItem"><a code="<%= ExternalAuthParty.Twitter %>" class="item_Twitter" title="Twitter"></a></li>
            <%} %>
            <% if (AuthParty_Setting.Enable_VKontakte)
               { %>
            <li class="externalItem"><a code="<%= ExternalAuthParty.VKontakte %>" class="item_VKontakte" title="VK"></a></li>
            <%} %>
            <% if (AuthParty_Setting.Enable_Yandex)
               { %>
            <li class="externalItem"><a code="<%= ExternalAuthParty.Yandex %>" class="item_Yandex" title="Yandex"></a></li>
            <%} %>
        </ul>
    </div>
