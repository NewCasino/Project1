...
<ui:Panel runat="server" ID="pnForgotUsername">

<center>
    <%: Html.InformationMessage( this.GetMetadata(".Message") ) %>
</center>
<% using( Html.BeginRouteForm( "ForgotUsername", new { @action = "SendEmail" }, FormMethod.Post, new { @id="formForgotUsername", @target="_self" } ) )
   { %>
...
<center>
    <%: Html.Button(this.GetMetadata(".Button_Submit"), new { @id = "btnSendForgotUsernameEmail", @type = "submit" })%>
</center>
...
<script language="javascript" type="text/javascript">
    $(document).ready(function () {
        $('#formForgotUsername').initializeForm();

        $('#btnSendForgotUsernameEmail').click(function (e) {
            if (!$('#formForgotUsername').valid()) {
                e.preventDefault();
                return;
            }
