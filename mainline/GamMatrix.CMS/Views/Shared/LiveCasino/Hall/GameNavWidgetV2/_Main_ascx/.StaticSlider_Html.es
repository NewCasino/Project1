<div class="Slider LiveCasinoSlider" >
    <ul data-slide="Default" class="SliderContainer LiveCasinoSliderContainer" >
        <li id="LCSlide-Default" data-bg="" data-state="active" class="SliderItem LiveCasinoSlide LCSlide-Default Active">
            <div class="SliderContent">
                <h3 class="LCSlideTitle SlideTitle">
                    <span class="SlideWelcome">Bienvenido a </span>
                    <span class="hidable SlideDefaultTitle">Artemisbet</span>
        ...
        <li id="LCSlide-ROULETTE" data-bg="" data-state="hidden" class="SliderItem LiveCasinoSlide LCSlide-Roulette">
            <div class="SliderContent">
                <h3 class="LCSlideTitle SlideTitle">
                    <span class="SlideWelcome">Bienvenido a Artemisbet</span>
 ...
 <li id="LCSlide-POKER" data-bg="" data-state="hidden" class="SliderItem LiveCasinoSlide LCSlide-Poker">
            <div class="SliderContent">
                <h3 class="LCSlideTitle SlideTitle">
                    <span class="SlideWelcome">Bienvenido a Artemisbet</span>
                    <span class="CategorySlideTitle">Poker</span>
                </h3>
            </div>
        </li>
 ...
 <li id="LCSlide-VIP-Default" data-bg="" data-state="hidden" class="SliderItem LiveCasinoSlide LCSlide-VIP-Default">
            <div class="SliderContent">
                <h3 class="LCSlideTitle SlideTitle">
                    <span class="SlideWelcome">Bienvenido a</span>
                    <span class="hidable SlideDefaultTitle">Artemisbet</span>
                    <span class="CategorySlideTitle">VIP CLUB</span>
                </h3>
                <span class="CasinoCoin LeftCoin">&nbsp;</span>
                <span class="CasinoCoin RightCoin">&nbsp;</span>
            </div>
