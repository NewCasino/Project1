...
<ui:InputField ID="fldCPRNumber" runat="server" ShowDefaultIndicator="true" BalloonArrowDirection="Left">
    <labelpart><%=this.GetMetadata(".CPRNumber_Label").HtmlEncodeSpecialCharactors() %></labelpart>
    <controlpart>
        <span class="CPRDOB">
        ...
        <span class="CPRNum">
        <%: Html.DropDownList( "ddlDay2", GetDayList())%>
        <%: Html.DropDownList( "ddlMonth2", GetMonthList())%>
        <%: Html.DropDownList("ddlYear2", GetYearList(), new { @validator = ClientValidators.Create().RequiredIf( "isBirthDateRequired", this.GetMetadata("/Register/_PersionalInformation_ascx.DOB_Empty")).Custom("validateBirthday") })%>
        ...
        <%: Html.TextBox("preCPRNumber2", "", new 
            {
                @maxlength =6,
                @title=this.GetMetadata(".CPRNumber_Holder"),
                @style="display:none;",
                @id = "preCPRNumber2", @validator = ClientValidators.Create()
        ...
        %><%: Html.TextBox("CPRNumber", "", new 
            {
                ...
                @id = "txtCPRNumber2", @validator = ClientValidators.Create()
                            .RequiredIf("isCPRNumberRequired", this.GetMetadata(".CPRNumber_Empty"))
                            .Custom("validateCPRNumber")             
            }
        ) %>
        ...
        <%--</ui:MinifiedJavascriptControl>--%>                                                 
            <ui:InputField ID="fldIntendedVolume2" runat="server" ShowDefaultIndicator="true" BalloonArrowDirection="Left">
                <labelpart><%= this.GetMetadata(".IntendedVolume_Label").SafeHtmlEncode()%></labelpart>
                <controlpart>
                  <%: Html.DropDownList("intendedVolume", GetIntendedVolumeList(), new
                        {
