...
<script language="C#" type="text/C#" runat="server">
    ...
    private bool IsSecurityQuestionRequired { get { return this.Model != null || Settings.Registration.IsSecurityQuestionRequired; } }

    private bool IsSecurityAnswerVisible { get { return this.Model != null || Settings.Registration.IsSecurityAnswerVisible; } }
    private bool IsSecurityAnswerRequired { get { return this.Model != null || Settings.Registration.IsSecurityAnswerRequired; } }

    private bool IsPassportVisible { get { return Settings.Registration.IsPassportVisible; } }
    private bool IsPassportRequired { get { return Settings.Registration.IsPassportRequired; } }
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        fldPassport.Visible = this.IsPassportVisible;
        scriptPassport.Visible = this.IsPassportVisible;
...
<%------------------------------------------
    Passport
 -------------------------------------------%>
 <ui:InputField ID="fldPassport" runat="server" ShowDefaultIndicator="true" BalloonArrowDirection="Left">
 <LabelPart>
     <%= this.GetMetadata(".Passport_Label").SafeHtmlEncode() %>
     <span class="inputfield_help"><span class="icon">i</span><span class="inputfield_tip"><%=this.GetMetadata(".Passport_Tip").HtmlEncodeSpecialCharactors() %></span></span>
 </LabelPart>
 <ControlPart>

<div class="PassportBox">
    <%: Html.Hidden("passport", this.Passport, new 
    {
        @id="txtPassport",
        @validator = ClientValidators.Create().Required(this.GetMetadata(".Passport_Empty"))
    }) %>
    ...
    <div class="PassportImage_Button">
        <input type="file" name="uploadPassport" class="hidden" accept=".bmp,.jpg,.jpeg,.gif,.png,.tiff,.tif" style="display:none;" />
        <% if (!Profile.IsAuthenticated || (Profile.IsAuthenticated && string.IsNullOrEmpty(this.Passport))) { %>
...
<ui:MinifiedJavascriptControl runat="server" ID="scriptPassport" AppendToPageEnd="true" Enabled="false">
        ...
        $('input[name="uploadPassport"]').on('change', function() {
            ...
            fr.onload = function() {
                ...
                img.onload = function() {
                    ...
                    $("#txtPassport").val($(".PassportImage img").prop("src"));
