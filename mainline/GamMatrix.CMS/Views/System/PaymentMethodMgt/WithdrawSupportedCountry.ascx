...
<script language="C#" type="text/C#" runat="server">
    private SelectListItem [] GetCountryList()
    {
        ...
        var selectedList = (paymentMethod.WithdrawSupportedCountries ?? new CountryList()).List;
    ...
    {
        return ((this.ViewData["paymentMethod"] as PaymentMethod).WithdrawSupportedCountries ?? new CountryList()).Type == CountryList.FilterType.Exclude;
    }
</script>
...
<script language="javascript" type="text/javascript">
    $('#btnSaveCountryList').click( function (e) {
        ...
        $('#formSaveWithdrawSupportedCountry').ajaxForm(options);
        $('#formSaveWithdrawSupportedCountry').submit();
    });
