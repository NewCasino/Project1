...
<div class="ui-widget">
	<div style="margin-top: 20px; padding: 0pt 0.7em;" class="ui-state-highlight ui-corner-all"> 
		<p id="info-wrapper">
		<img src="/images/icon/loading.gif" align="absmiddle" /> Searching in metadata library. Please be patient and <strong>DO NOT</strong> refresh this page.
        </p>
	</div>
</div>
...
<script language="javascript" type="text/javascript">
    $(function () {
        function loadResult() {
            var url = '<%= this.Url.RouteUrl( "SearchMetadata", new { @action = "GetResult", @distinctName = this.Model.DistinctName.DefaultEncrypt(), @taskID = this.ViewData["TaskID"] }).SafeJavascriptStringEncode() %>';
