...
<% 
    using (Html.BeginRouteForm("SiteManager", new
   {
...
<label for="Exclude">Only the selected country(s) are <strong>NOT</strong> supported for this site.</label>
<br />
<%: Html.RadioButton("filterType", CountryList.FilterType.Include, !IsExcluded(), new { @id = "Include" })%>
<label for="Include">Only the selected country(s) are supported for this site.</label>
<hr />
