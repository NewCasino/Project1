...
<head runat="server">
    ...
    .inputfield .inputfield_Label { float:left; font-weight:600; clear:both; width:100%;}
    .inputfield .inputfield_Container { float:left; clear:both; }
    ...
    /***********************************************/
    .bubbletip { position:absolute; top:0px; left:0px; display:none; }
    ...
    .left .bubbletip_Container { left:12px; top:0px; }
    ...
    .top .bubbletip_Container { left:0px; top:10px; }
    </style>
</head>
