...
namespace GamMatrix.CMS.Controllers._777DKMobile
{
    [HandleError]
    [ControllerExtraInfo(DefaultAction = "Step1")]
    public class _777DKMobileRegisterController : RegistrationController
    {
            ...
            , string dOBPlace, string registerCaptcha = null, string iovationBlackBox = null, string passport = null, string contractValidity = null)
        {
            ...
            , intendedVolume
            , dOBPlace, registerCaptcha, iovationBlackBox);
                return;
            }
