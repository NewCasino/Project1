...
namespace GamMatrix.CMS.Controllers.DragonbetMobile
{
    ...
    public class DragonbetMobileDepositController : MobileDepositController
    {
        [HttpPost]
        [RequireLogin]
            ...
            , string bankAccountNo)
        {
            ...
            if (CustomProfile.Current.UserCountryID == 202 || CustomProfile.Current.UserCountryID == 51) // Korea
            {
