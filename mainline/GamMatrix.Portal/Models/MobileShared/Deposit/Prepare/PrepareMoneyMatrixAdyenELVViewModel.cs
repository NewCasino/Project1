...
{
    public class PrepareMoneyMatrixAdyenELVViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixAdyenELVViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
