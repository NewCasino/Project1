...
{
    public class PrepareMoneyMatrixAdyenGiropayViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixAdyenGiropayViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
