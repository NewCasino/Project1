...
{
    public class PrepareMoneyMatrixAdyenPayPalViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixAdyenPayPalViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
