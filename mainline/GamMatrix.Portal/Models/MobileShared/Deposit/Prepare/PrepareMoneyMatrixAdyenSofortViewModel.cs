...
{
    public class PrepareMoneyMatrixAdyenSofortViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixAdyenSofortViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
