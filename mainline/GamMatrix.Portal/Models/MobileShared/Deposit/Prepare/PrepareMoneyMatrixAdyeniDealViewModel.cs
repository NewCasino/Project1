...
{
    public class PrepareMoneyMatrixAdyeniDealViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixAdyeniDealViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
