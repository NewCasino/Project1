...
{
    public class PrepareMoneyMatrixEcoPayzViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixEcoPayzViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
        ...
        {
            return GamMatrixClient.GetPayCards(VendorID.MoneyMatrix).Where(c => c.IsDummy);
        }
    }
}