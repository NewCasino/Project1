...
{
    public class PrepareMoneyMatrixEproCashlibViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixEproCashlibViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
