...
{
    public class PrepareMoneyMatrixGPaySafeCashIxirViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeCashIxirViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
