...
{
    public class PrepareMoneyMatrixGPaySafeCepBankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeCepBankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
