...
{
    public class PrepareMoneyMatrixGPaySafeEPayCodeViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeEPayCodeViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
