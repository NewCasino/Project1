...
{
    public class PrepareMoneyMatrixGPaySafeGsCashViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeGsCashViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
