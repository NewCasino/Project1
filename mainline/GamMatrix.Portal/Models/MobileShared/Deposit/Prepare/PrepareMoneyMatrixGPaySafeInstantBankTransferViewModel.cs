...
{
    public class PrepareMoneyMatrixGPaySafeInstantBankTransferViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeInstantBankTransferViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
