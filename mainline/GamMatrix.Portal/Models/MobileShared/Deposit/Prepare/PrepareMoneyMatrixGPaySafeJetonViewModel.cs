...
{
    public class PrepareMoneyMatrixGPaySafeJetonViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeJetonViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
