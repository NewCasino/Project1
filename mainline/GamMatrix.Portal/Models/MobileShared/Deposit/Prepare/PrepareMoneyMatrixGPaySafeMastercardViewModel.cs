...
{
    public class PrepareMoneyMatrixGPaySafeMastercardViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeMastercardViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
