...
{
    public class PrepareMoneyMatrixGPaySafePayKasaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafePayKasaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
