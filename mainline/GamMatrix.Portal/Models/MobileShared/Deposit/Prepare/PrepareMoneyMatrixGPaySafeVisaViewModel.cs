...
{
    public class PrepareMoneyMatrixGPaySafeVisaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixGPaySafeVisaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
