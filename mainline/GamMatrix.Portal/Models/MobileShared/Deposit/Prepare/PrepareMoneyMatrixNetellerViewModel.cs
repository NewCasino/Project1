...
{
    public class PrepareMoneyMatrixNetellerViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixNetellerViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
