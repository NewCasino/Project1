...
{
    public class PrepareMoneyMatrixOfflineLocalBankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixOfflineLocalBankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
