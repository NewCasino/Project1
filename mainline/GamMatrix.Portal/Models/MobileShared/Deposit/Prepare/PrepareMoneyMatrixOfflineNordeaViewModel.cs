...
{
    public class PrepareMoneyMatrixOfflineNordeaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixOfflineNordeaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
