...
{
    public class PrepareMoneyMatrixPaySafeCardViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPaySafeCardViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
