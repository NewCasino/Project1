...
{
    public class PrepareMoneyMatrixPayseraAliorBankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraAliorBankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
