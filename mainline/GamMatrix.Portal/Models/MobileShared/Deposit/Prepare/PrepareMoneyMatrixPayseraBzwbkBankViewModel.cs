...
{
    public class PrepareMoneyMatrixPayseraBzwbkBankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraBzwbkBankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
