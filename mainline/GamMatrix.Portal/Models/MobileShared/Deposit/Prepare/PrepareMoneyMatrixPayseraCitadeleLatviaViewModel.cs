...
{
    public class PrepareMoneyMatrixPayseraWalletViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraWalletViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
