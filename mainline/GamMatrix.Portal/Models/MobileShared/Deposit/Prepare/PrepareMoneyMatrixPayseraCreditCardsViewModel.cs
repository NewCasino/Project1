...
{
    public class PrepareMoneyMatrixPayseraCreditCardsViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraCreditCardsViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
