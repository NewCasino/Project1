...
{
    public class PrepareMoneyMatrixPayseraDnbViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraDnbViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
