...
{
    public class PrepareMoneyMatrixPayseraInternationalPaymentInEurosViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraInternationalPaymentInEurosViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
