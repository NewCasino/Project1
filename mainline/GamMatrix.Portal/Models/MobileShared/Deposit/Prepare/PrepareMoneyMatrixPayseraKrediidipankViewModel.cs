...
{
    public class PrepareMoneyMatrixPayseraKrediidipankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraKrediidipankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
