...
{
    public class PrepareMoneyMatrixPayseraLithuanianCreditUnionViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraLithuanianCreditUnionViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
