...
{
    public class PrepareMoneyMatrixPayseraMedicinosBankasViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraMedicinosBankasViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
