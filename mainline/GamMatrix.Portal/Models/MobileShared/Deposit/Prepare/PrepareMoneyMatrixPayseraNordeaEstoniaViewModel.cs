...
{
    public class PrepareMoneyMatrixPayseraNordeaEstoniaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraNordeaEstoniaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
