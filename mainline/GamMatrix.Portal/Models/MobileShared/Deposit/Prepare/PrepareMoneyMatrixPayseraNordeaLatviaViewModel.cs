...
{
    public class PrepareMoneyMatrixPayseraNordeaLatviaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraNordeaLatviaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
