...
{
    public class PrepareMoneyMatrixPayseraNordeaLithuaniaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraNordeaLithuaniaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
