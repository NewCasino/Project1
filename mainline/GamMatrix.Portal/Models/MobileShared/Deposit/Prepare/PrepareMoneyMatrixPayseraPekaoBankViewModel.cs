...
{
    public class PrepareMoneyMatrixPayseraPekaoBankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraPekaoBankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
