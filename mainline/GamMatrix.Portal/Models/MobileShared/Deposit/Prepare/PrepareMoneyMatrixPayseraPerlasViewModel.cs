...
{
    public class PrepareMoneyMatrixPayseraPerlasViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraPerlasViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
