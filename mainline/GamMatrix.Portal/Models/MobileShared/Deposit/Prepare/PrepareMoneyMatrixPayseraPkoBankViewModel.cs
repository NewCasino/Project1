...
{
    public class PrepareMoneyMatrixPayseraPkoBankViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraPkoBankViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
