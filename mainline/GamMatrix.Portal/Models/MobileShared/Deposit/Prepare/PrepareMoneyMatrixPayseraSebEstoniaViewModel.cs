...
{
    public class PrepareMoneyMatrixPayseraSebEstoniaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSebEstoniaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
