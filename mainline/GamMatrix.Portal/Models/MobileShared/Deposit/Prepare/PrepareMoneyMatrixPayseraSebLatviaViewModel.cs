...
{
    public class PrepareMoneyMatrixPayseraSebLatviaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSebLatviaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
