...
{
    public class PrepareMoneyMatrixPayseraSebLithuaniaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSebLithuaniaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
