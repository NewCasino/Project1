...
{
    public class PrepareMoneyMatrixPayseraSiauliuBankasViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSiauliuBankasViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
