...
{
    public class PrepareMoneyMatrixPayseraSwedbankEstoniaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSwedbankEstoniaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
