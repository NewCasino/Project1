...
{
    public class PrepareMoneyMatrixPayseraSwedbankLatviaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSwedbankLatviaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
