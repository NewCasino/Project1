...
{
    public class PrepareMoneyMatrixPayseraSwedbankLithuaniaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraSwedbankLithuaniaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
