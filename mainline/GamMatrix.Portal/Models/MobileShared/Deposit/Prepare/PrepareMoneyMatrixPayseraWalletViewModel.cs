...
{
    public class PrepareMoneyMatrixPayseraCitadeleLatviaViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraCitadeleLatviaViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
