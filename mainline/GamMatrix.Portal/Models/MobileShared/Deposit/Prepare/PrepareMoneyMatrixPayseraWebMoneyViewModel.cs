...
{
    public class PrepareMoneyMatrixPayseraWebMoneyViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixPayseraWebMoneyViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
