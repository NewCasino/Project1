...
{
    public class PrepareMoneyMatrixSkrill_1Tap_ViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixSkrill_1Tap_ViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
