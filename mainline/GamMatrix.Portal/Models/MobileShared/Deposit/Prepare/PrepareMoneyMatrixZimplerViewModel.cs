...
{
    public class PrepareMoneyMatrixZimplerViewModel : PayCardTransaction
    {
        public PayCardInfoRec ExistingPayCard { get; protected set; }

        public PrepareMoneyMatrixZimplerViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
