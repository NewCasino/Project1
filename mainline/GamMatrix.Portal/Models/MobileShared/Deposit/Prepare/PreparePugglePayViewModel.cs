...
{
    public class PreparePugglePayViewModel : SinglePayCardTransaction
    {
        public PreparePugglePayViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
