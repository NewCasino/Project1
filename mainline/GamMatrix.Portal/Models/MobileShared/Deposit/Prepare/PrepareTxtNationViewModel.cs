...
{
    public class PrepareTxtNationViewModel: PayCardTransaction
    {
        public PrepareTxtNationViewModel(PaymentMethod paymentMethod, Dictionary<string, string> stateVars)
